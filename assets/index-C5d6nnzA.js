...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function hs(e,t,n){let r=new Float32Array(ts),i=new W(0,1,0);return new ri({name:`SphericalGaussianBlur`,defines:{n:ts,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:vs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function gs(){return new ri({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:vs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function _s(){return new ri({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:vs(),fragmentShader:`
...
void main() {
    ...
    `,document.head.appendChild(t);let n=document.createElement(`div`);n.style.background=`rgba(255,255,255,0.08)`,n.style.backdropFilter=`blur(18px)`,n.style.border=`1px solid rgba(255,255,255,0.15)`,n.style.borderRadius=`14px`,n.style.padding=`20px`,n.style.maxWidth=`90%`,n.style.maxHeight=`85%`,n.style.overflowY=`auto`,n.style.display=`grid`,n.style.gridTemplateColumns=`repeat(auto-fit, minmax(220px, 1fr))`,n.style.gap=`18px`,n.style.boxShadow=`0 8px 30px rgba(0,0,0,0.4)`,n.style.animation=`fadeInShop 0.25s ease`;let r=document.createElement(`div`);r.style.gridColumn=`1 / -1`,r.style.display=`flex`,r.style.justifyContent=`space-between`,r.style.alignItems=`center`,r.style.marginBottom=`10px`,r.style.color=`white`,r.style.fontSize=`20px`,r.style.fontWeight=`700`;let i=document.createElement(`div`);i.textContent=`Boutique de Skins`;let a=document.createElement(`div`);a.textContent=`✕`,a.style.cursor=`pointer`,a.style.fontSize=`22px`,a.onclick=u,r.appendChild(i),r.appendChild(a),n.appendChild(r);let o=document.createElement(`div`);o.textContent=`Coins : ${id}`,o.style.gridColumn=`1 / -1`,o.style.color=`white`,o.style.marginBottom=`10px`,n.appendChild(o);let s=[];for(let t=0;t<nd.length;t++){let r=nd[t],i=200*t,a=rd.has(r),c=document.createElement(`div`);c.style.background=`rgba(255,255,255,0.08)`,c.style.backdropFilter=`blur(10px)`,c.style.border=`1px solid rgba(255,255,255,0.15)`,c.style.borderRadius=`10px`,c.style.padding=`12px`,c.style.display=`flex`,c.style.flexDirection=`column`,c.style.alignItems=`center`,c.style.color=`white`,c.style.boxShadow=`0 4px 12px rgba(0,0,0,0.3)`;let l=document.createElement(`canvas`);l.width=200,l.height=200,l.style.borderRadius=`6px`,l.style.marginBottom=`10px`,c.appendChild(l);let d=document.createElement(`div`);d.textContent=r,d.style.fontWeight=`600`,d.style.marginBottom=`6px`,c.appendChild(d);let f=document.createElement(`button`);f.style.padding=`8px 12px`,f.style.border=`none`,f.style.borderRadius=`6px`,f.style.cursor=`pointer`,f.style.background=a?`#4caf50`:`#2196f3`,f.style.color=`white`,f.textContent=a?`Select`:`Buy (${i}c)`,f.onclick=async()=>{if(!a&&id<i){alert(`Pas assez de coins`);return}a||(cd(id-i),rd.add(r),f.textContent=`Select`,f.style.background=`#4caf50`,o.textContent=`Coins : ${id}`);let t=await dd(r);u(),e(t,r)},c.appendChild(f),n.appendChild(c);let p=new vi;p.background=new J(2236962);let m=new ci(45,1,.1,100);m.position.set(0,1.2,2.5);let h=new _o(16777215,1);h.position.set(5,10,7),p.add(h),p.add(new vo(16777215,.6));let g=new nu({canvas:l,alpha:!0,antialias:!0});g.setSize(200,200);let _={renderer:g,scene:p,cam:m,mesh:null,mixer:null,rot:0};s.push(_),ud.load(r,e=>{let t=e.scene.clone(!0),n=new Zt().setFromObject(t),r=new W;n.getSize(r);let i=1.8/(r.y||1);t.scale.setScalar(i),t.rotation.y=Math.PI;let a=new Ro(t);for(let t of e.animations)a.clipAction(t).play();_.mesh=t,_.mixer=a,p.add(t)})}let c=performance.now();function l(e){let t=(e-c)/1e3;c=e;for(let e of s)e.mesh&&(e.rot+=t*1.2,e.mesh.rotation.y=e.rot,e.mixer&&e.mixer.update(t),e.renderer.render(e.scene,e.cam));md=requestAnimationFrame(l)}md=requestAnimationFrame(l),pd.appendChild(n),document.body.appendChild(pd);function u(){fd=!1,cancelAnimationFrame(md),pd&&pd.parentNode&&pd.parentNode.removeChild(pd),pd=null}}let gd=!1,_d=0,vd=0,yd=0,bd=0,xd=0,Sd=0,Cd=!1,wd=!1;var Td=null,Ed=null,Dd=null,Od=null;function kd(e,t){let n=document.createElement(`style`);n.textContent=`
        ...
        .mobile-button-jump {
 bottom: 20px; right: 20px; height : 140px; width: 140px; }
        .mobile-button-fps { bottom: 170px; right: 20px; }
        .mobile-button-sprint { bottom: 20px; right: 180px; }
    ...
    `,document.head.appendChild(n);let r=document.createElement(`div`);r.className=`mobile-controls`;let i=document.createElement(`div`);i.className=`joystick-background`;let a=document.createElement(`div`);a.className=`joystick-stick`,i.appendChild(a),r.appendChild(i),e.appendChild(r);let o=document.createElement(`div`);o.className=`mobile-button mobile-button-jump`,o.textContent=`JUMP`,e.appendChild(o);let s=document.createElement(`div`);s.className=`mobile-button mobile-button-fps`,s.textContent=`FPS/TPS`,e.appendChild(s);let c=document.createElement(`div`);c.className=`mobile-button mobile-button-sprint`,c.textContent=`SPRINT`,e.appendChild(c);let l=document.createElement(`div`);l.className=`camera-zone`,e.appendChild(l),r.addEventListener(`touchstart`,e=>{for(let t of e.changedTouches){if(t.clientX>window.innerWidth*.5||Td!==null)continue;Td=t.identifier;let e=r.getBoundingClientRect();_d=e.left+e.width/2,vd=e.top+e.height/2,gd=!0,u(t.clientX,t.clientY,a)}},{passive:!1}),r.addEventListener(`touchmove`,e=>{for(let t of e.changedTouches)t.identifier===Td&&u(t.clientX,t.clientY,a)},{passive:!1}),r.addEventListener(`touchend`,e=>{for(let t of e.changedTouches)t.identifier===Td&&(Td=null,gd=!1,yd=0,bd=0,a.style.transform=`translate(0,0)`)},{passive:!1});function u(e,t,n){let r=e-_d,i=t-vd,a=Math.sqrt(r*r+i*i),o=r,s=i;a>50&&(o=r/a*50,s=i/a*50),yd=o,bd=s,n.style.transform=`translate(${o}px, ${s}px)`}l.addEventListener(`touchstart`,e=>{for(let t of e.changedTouches)Ed===null&&(Ed=t.identifier,xd=t.clientX,Sd=t.clientY)},{passive:!1}),l.addEventListener(`touchmove`,e=>{for(let n of e.changedTouches){if(n.identifier!==Ed)continue;let e=n.clientX-xd,r=n.clientY-Sd;xd=n.clientX,Sd=n.clientY,t.rotY-=e*.004,t.rotX-=r*.004,t.rotX=Math.max(-1.4,Math.min(1.4,t.rotX))}},{passive:!1}),l.addEventListener(`touchend`,e=>{for(let t of e.changedTouches)t.identifier===Ed&&(Ed=null)},{passive:!1}),o.addEventListener(`touchstart`,e=>{for(let t of e.changedTouches)Dd===null&&(Dd=t.identifier,Cd=!0)},{passive:!1}),o.addEventListener(`touchend`,e=>{for(let t of e.changedTouches)t.identifier===Dd&&(Dd=null,Cd=!1)},{passive:!1}),c.addEventListener(`touchstart`,e=>{for(let t of e.changedTouches)Od===null&&(Od=t.identifier,wd=!wd,c.style.background=wd?`rgba(0,255,100,0.7)`:`rgba(100,100,150,0.6)`)},{passive:!1}),c.addEventListener(`touchend`,e=>{for(let t of e.changedTouches)t.identifier===Od&&(Od=null)},{passive:!1}),s.addEventListener(`touchstart`,e=>{e.preventDefault(),t.isFPS=!t.isFPS,t.playerModel&&(t.playerModel.visible=!t.isFPS)},{passive:!1})}var Ad=new io,jd=document.getElementById(`game-container`)||document.body,Q={isFPS:!0,playerModel:null,rotX:0,rotY:0,faceViewActive:!1},Md=new vi;Md.background=new J(8900331);var Nd=new ci(75,window.innerWidth/window.innerHeight,.1,1e3);Nd.rotation.order=`YXZ`;var $=new W(0,3,0),Pd=4,Fd=1.5,Id=new nu({antialias:!0});Id.setSize(window.innerWidth,window.innerHeight),Id.domElement.style.touchAction=`none`,jd.appendChild(Id.domElement);var Ld=document.createElement(`div`);Ld.id=`water-overlay`,Ld.style.position=`fixed`,Ld.style.left=`0`,Ld.style.top=`0`,Ld.style.width=`100%`,Ld.style.height=`100%`,Ld.style.pointerEvents=`none`,Ld.style.opacity=`0`,Ld.style.transition=`opacity 0.6s ease`,Ld.style.mixBlendMode=`overlay`,Ld.style.zIndex=`999`,jd.appendChild(Ld);var Rd=document.createElement(`style`);Rd.textContent=`
@keyframes causticsMove { from { background-position: 0 0; } to { background-position: 200px 200px; } }
#water-overlay { background-image: radial-gradient(rgba(255,255,255,0.03) 10%, transparent 40%), linear-gradient(rgba(10,60,95,0.45), rgba(10,60,95,0.35)); background-blend-mode: overlay; background-size: 120px 120px, cover; animation: causticsMove 8s linear infinite; }
`,document.head.appendChild(Rd);var zd=document.createElement(`div`);zd.style.position=`fixed`,zd.style.left=`12px`,zd.style.top=`12px`,zd.style.zIndex=`1000`,zd.style.display=`flex`,zd.style.flexDirection=`column`,zd.style.gap=`8px`,zd.style.fontFamily=`sans-serif`,jd.appendChild(zd);var Bd=document.createElement(`div`);Bd.style.color=`white`,Bd.style.background=`rgba(0,0,0,0.4)`,Bd.style.padding=`6px 10px`,Bd.style.borderRadius=`6px`,Bd.textContent=`Coins: ${od()}`,zd.appendChild(Bd);var Vd=document.createElement(`button`);Vd.textContent=`Shop (B)`,Vd.onclick=()=>{hd((e,t)=>{e&&(Q.playerModel&&Q.playerModel.parent&&Md.remove(Q.playerModel),Q.playerModel=e,Md.add(Q.playerModel),Q.playerModel.visible=!Q.isFPS)})},zd.appendChild(Vd),sd(e=>{Bd.textContent=`Coins: ${e}`});var Hd=new _o(16777215,1);Hd.position.set(-10,30,5),Md.add(Hd);var Ud=new vo(16777215,.7);Md.add(Ud);var Wd=Hd.intensity,Gd=Ud.intensity,Kd,qd=null,Jd=[],Yd=[],Xd=[],Zd=[],Qd=0,$d=null,ef=Md.background.clone(),tf=Nd.fov,nf=null;Ad.load(`galaxy.png`,e=>{$d=e,nf=new Kr(new Ta(200,32,32),new yr({map:$d,side:1})),Md.add(nf)});var rf=0,af=!1,of=.05,sf=.25,cf=.01;kd(jd,Q);var lf=new Map,uf={};document.addEventListener(`keydown`,e=>{uf[e.code]=!0,e.code===`ArrowUp`&&!pf&&(Q.isFPS=!Q.isFPS,Q.playerModel&&(Q.playerModel.visible=!Q.isFPS))}),document.addEventListener(`keyup`,e=>uf[e.code]=!1);var df=!1,ff=!1;document.addEventListener(`mousedown`,e=>{e.button===2&&(df=!0),e.button===0&&(ff=!0)}),document.addEventListener(`mouseup`,e=>{e.button===2&&(df=!1),e.button===0&&(ff=!1)}),document.addEventListener(`contextmenu`,e=>e.preventDefault()),document.addEventListener(`mousemove`,e=>{df&&!Q.faceViewActive&&(Q.rotY-=e.movementX*.002,Q.rotX-=e.movementY*.002,Q.rotX=Math.max(-1.4,Math.min(1.4,Q.rotX)))});var pf=null;window.addEventListener(`gamepadconnected`,e=>{pf=e.gamepad.index}),window.addEventListener(`gamepaddisconnected`,()=>{pf=null});function mf(){return pf===null?null:navigator.getGamepads()[pf]}new iu().load(`parcours.glb`,e=>{Kd=e.scene,Md.add(Kd),Kd.traverse(e=>{if(e.name===`PlayerSpawn`&&(qd=e),e.name.startsWith(`Collision_`)&&(Jd.push(new Zt().setFromObject(e)),console.log(`✓ Collision (Monde 1):`,e.name)),e.name.toLowerCase().includes(`eau`))if(e.isMesh||e.children&&e.children.length>0)Yd.push(new Zt().setFromObject(e));else{let t=e.scale?e.scale.clone():new W(1,1,1),n=new W(Math.max(.1,Math.abs(t.x)),Math.max(.1,Math.abs(t.y)),Math.max(.1,Math.abs(t.z)));Yd.push(new Zt().setFromCenterAndSize(e.position.clone(),n))}e.name.toLowerCase().includes(`piece`)&&(e.isMesh?Xd.push(e):e.children&&e.children.length>0&&e.traverse(e=>{e.isMesh&&Xd.push(e)})),e.name.toLowerCase()===`changeworld`&&Zd.push(e)}),qd&&$.copy(qd.position)}),dd(nd[0]).then(e=>{e&&(Q.playerModel=e,Md.add(Q.playerModel),Q.playerModel.visible=!Q.isFPS,lf.clear(),Q.playerModel.traverse(e=>{e.isMesh&&e.name.startsWith(`Stay_`)&&lf.set(e,{rotX:e.rotation.x,rotY:e.rotation.y,rotZ:e.rotation.z,posX:e.position.x,posY:e.position.y,posZ:e.position.z})}))}).catch(e=>console.error(`Erreur chargement skin initial`,e)),document.addEventListener(`keydown`,e=>{e.code===`KeyB`&&hd((e,t)=>{e&&(Q.playerModel&&Q.playerModel.parent&&Md.remove(Q.playerModel),Q.playerModel=e,Md.add(Q.playerModel),Q.playerModel.visible=!Q.isFPS,lf.clear(),Q.playerModel.traverse(e=>{e.isMesh&&e.name.startsWith(`Stay_`)&&lf.set(e,{rotX:e.rotation.x,rotY:e.rotation.y,rotZ:e.rotation.z,posX:e.position.x,posY:e.position.y,posZ:e.position.z})}))})});var hf=[`parcours.glb`,`parcours2.glb`,`parcours3.glb`];function gf(){requestAnimationFrame(gf),performance.now()/1e3,Q.playerModel&&Q.playerModel.mixer&&Q.playerModel.mixer.update(.016666666666666666);let e=$.clone(),t=mf();t&&t.buttons[12]?.pressed&&!uf._switchUpLatch&&(uf._switchUpLatch=!0,Q.isFPS=!Q.isFPS,Q.playerModel&&(Q.playerModel.visible=!Q.isFPS)),t&&!t.buttons[12]?.pressed&&(uf._switchUpLatch=!1),t&&t.buttons[2]?.pressed&&!uf._shopLatch&&(uf._shopLatch=!0,hd((e,t)=>{e&&(Q.playerModel&&Q.playerModel.parent&&Md.remove(Q.playerModel),Q.playerModel=e,Md.add(Q.playerModel),Q.playerModel.visible=!Q.isFPS,lf.clear(),Q.playerModel.traverse(e=>{e.isMesh&&e.name.startsWith(`Stay_`)&&lf.set(e,{rotX:e.rotation.x,rotY:e.rotation.y,rotZ:e.rotation.z,posX:e.position.x,posY:e.position.y,posZ:e.position.z})}))})),t&&!t.buttons[2]?.pressed&&(uf._shopLatch=!1);let n=2;t&&t.buttons[10]?.pressed&&(n=4),uf.ShiftLeft&&uf.KeyW&&(n=4),wd&&(n=4);let r=new W;if(uf.KeyW&&--r.z,uf.KeyS&&(r.z+=1),uf.KeyA&&--r.x,uf.KeyD&&(r.x+=1),t){let e=t.axes[0],n=t.axes[1],i=.15;r.x+=Math.abs(e)>i?e:0,r.z+=Math.abs(n)>i?n:0}if(gd&&(r.x+=yd/50,r.z+=bd/50),r.length()>.01&&(r.normalize(),r.applyAxisAngle(new W(0,1,0),Q.rotY),$.add(r.multiplyScalar(of*n))),(uf.Space||ff||Cd||t&&t.buttons[0]?.pressed)&&af&&(rf=sf,af=!1),$.y+=rf,rf-=cf,t&&!Q.faceViewActive){let e=t.axes[2],n=t.axes[3],r=.15,i=Math.abs(e)>r?e:0,a=Math.abs(n)>r?n:0,o=.04;Q.rotY-=i*o,Q.rotX-=a*o,Q.rotX=Math.max(-1.4,Math.min(1.4,Q.rotX))}Q.faceViewActive=t&&t.buttons[13]?.pressed;let i=new Zt().setFromCenterAndSize(new W($.x,$.y-.9,$.z),new W(.6,1.8,.6));af=!1;for(let t of Jd)if(i.intersectsBox(t)){let n=$.y-.9,r=t.max.y;if(n<=r&&e.y-.9>=r){$.y=r+.9,rf=0,af=!0;continue}$.x=e.x,$.z=e.z}for(let e=Xd.length-1;e>=0;e--){let t=Xd[e];try{let n=new Zt().setFromObject(t);if(i.intersectsBox(n)){t.parent&&t.parent.remove(t),Xd.splice(e,1);try{ld(1)}catch(e){console.warn(`Impossible d'ajouter coin`,e)}}}catch{}}for(let e of Zd){let t=new Zt().setFromObject(e);if(i.intersectsBox(t)){let e=Qd+1;e>=hf.length&&(e=0);let t=hf[e];new iu().load(t,t=>{Kd&&Kd.parent&&Md.remove(Kd),Jd=[],Yd=[],Xd=[],Zd=[],Qd=e,Kd=t.scene,Md.add(Kd),Kd.traverse(e=>{e.name===`PlayerSpawn`&&(qd=e),e.name.startsWith(`Collision_`)&&Jd.push(new Zt().setFromObject(e)),e.name.toLowerCase().includes(`eau`)&&Yd.push(new Zt().setFromObject(e)),e.name.toLowerCase().includes(`piece`)&&(e.isMesh?Xd.push(e):e.traverse(e=>{e.isMesh&&Xd.push(e)})),e.name.toLowerCase().includes(`changeworld`)&&Zd.push(e)}),qd&&$.copy(qd.position)})}}let a=!1;for(let e of Yd)if(e.containsPoint($)){a=!0;break}if(a){let e=new J(670559);Md.background=e,Md.fog=new _i(e.getHex(),.06),Nd.fov!==60&&(Nd.fov=60,Nd.updateProjectionMatrix()),Hd.color.setHex(8966118),Hd.intensity=Wd*.45,Ud.intensity=Gd*.6,Ld!==void 0&&(Ld.style.opacity=`0.55`)}else Md.fog&&=null,Qd===1?Md.background.equals(ef)||(Md.background=ef.clone()):Qd===2&&$d&&(Md.background=$d),Nd.fov!==tf&&(Nd.fov=tf,Nd.updateProjectionMatrix()),Hd.color.setHex(16777215),Hd.intensity=Wd,Ud.intensity=Gd,Ld!==void 0&&(Ld.style.opacity=`0`);if(Q.playerModel&&(Q.playerModel.visible=!Q.isFPS,!Q.isFPS)){Q.playerModel.position.copy($),Q.playerModel.position.y-=.9,Q.faceViewActive||(Q.playerModel.rotation.y=Q.rotY+Math.PI);let e=n>=4?2.25:1.5,t=r.z*e,i=-r.x*e;Q.playerModel.rotation.x=Ot.lerp(Q.playerModel.rotation.x,t,.2),Q.playerModel.rotation.z=Ot.lerp(Q.playerModel.rotation.z,i,.2)}if(Q.isFPS)Nd.position.copy($),Nd.position.y+=.7,Nd.rotation.set(Q.rotX,Q.rotY,0);else{let e;if(Q.faceViewActive){let t=new W(0,1.6,-1.2);t.applyAxisAngle(new W(0,1,0),Q.rotY),e=new W($.x,$.y,$.z).add(t),Nd.position.lerp(e,.25),Nd.lookAt($.x,$.y+1.6,$.z)}else{let t=new W(0,0,Pd);t.applyAxisAngle(new W(1,0,0),Q.rotX),t.applyAxisAngle(new W(0,1,0),Q.rotY),e=new W($.x,$.y+Fd,$.z).add(t),Nd.position.lerp(e,.2),Nd.lookAt($.x,$.y+1,$.z)}}Id.render(Md,Nd)}gf();